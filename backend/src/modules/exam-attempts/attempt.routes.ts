...
router.post('/student/:id/start', requirePermission('exam.take'), validate(startExamSchema), controller.startAttempt);

// Student Taking & Proctoring Routes
router.get('/attempts/:attemptId', requirePermission('exam.read'), controller.getAttempt);
router.post('/attempts/:attemptId/answers', requirePermission('exam.take'), validate(batchSaveAnswersSchema), controller.saveAnswers);
...
router.post('/attempts/:attemptId/submit', requirePermission('exam.take'), controller.submitAttempt);
