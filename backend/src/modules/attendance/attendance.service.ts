...
export const getRoster = async (_currentUser: AuthUser, _query: RosterQuery) => {
  throw new AppError(
    "Legacy daily roster is disabled. Open a scheduled class session and mark attendance from Take Attendance or Attendance History.",
    410
  );
};
