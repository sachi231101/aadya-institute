...
export const setup2fa = async (
  ...
  try {
    const result = await securityService.setup2faService(toAuthUser(req));
    sendSuccess(res, result, 200, "2FA setup initiated");
  } catch (err) {
    next(err);
  }
};
...
export const verify2fa = async (
  ...
  try {
    const result = await securityService.verify2faService(
      toAuthUser(req),
      req.body.code
    );
    sendSuccess(res, result, 200, "2FA enabled");
  } catch (err) {
    next(err);
  }
};
...
export const disable2fa = async (
  ...
  try {
    const result = await securityService.disable2faService(
      toAuthUser(req),
      req.body
    );
    sendSuccess(res, result, 200, "2FA disabled");
  } catch (err) {
    next(err);
  }
};

export const recovery2fa = async (
  req: AuthenticatedRequest,
  res: Response,
  next: NextFunction
): Promise<void> => {
  try {
    const result = await securityService.consumeRecoveryCodeService(
      toAuthUser(req),
      req.body.code
    );
    sendSuccess(res, result, 200, "Recovery code accepted");
  } catch (err) {
    next(err);
  }
};
