...
export const MASTER_ENTITY_TYPES: MasterEntityTypeMeta[] = [
  ...
  { id: "designation", name: "Designation", category: "ACADEMIC_ORG", categoryName: MASTER_CATEGORY_LABELS.ACADEMIC_ORG, usedInPages: ["Add Faculty", "Settings"] },
  { id: "education", name: "Education", category: "ACADEMIC_ORG", categoryName: MASTER_CATEGORY_LABELS.ACADEMIC_ORG, usedInPages: ["Add Student", "Edit Student", "Add Faculty", "Enquiries"] },
  ...
  { id: "numberingseries", name: "Numbering Series", category: "SYSTEM_AUTOMATION", categoryName: MASTER_CATEGORY_LABELS.SYSTEM_AUTOMATION, usedInPages: ["Admissions", "Add Student", "Payments", "Enquiries", "Lead Conversion"] },
];
