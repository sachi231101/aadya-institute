...
export const CENTER_ITEM_READ_PERMISSIONS: Record<string, string[]> = {
  ...
  "faculty.batch_assignment": ["faculty.read", "batch.read"],
  ...
  "batches.create": ["batch.read"],
  "batches.student_allocation": ["batch.read", "student.read"],
  "batches.faculty_allocation": ["batch.read", "faculty.read"],
...
export const CENTER_ITEM_WRITE_PERMISSIONS: Record<string, string[]> = {
  ...
  "faculty.course_assignment": ["faculty.update"],
  "faculty.batch_assignment": ["faculty.update", "batch.update"],
  ...
  "batches.student_allocation": ["batch.update"],
  "batches.faculty_allocation": ["batch.update"],
