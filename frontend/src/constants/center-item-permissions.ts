...
export const CENTER_ITEM_WRITE_PERMISSIONS: Record<string, string[]> = {
  ...
  "leads.call_history": [],
  "admissions.enquiries": ["lead.create", "lead.update", "admission.create", "admission.update"],
  ...
  "fees.invoices": ["fee.create", "fee.update"],
  "fees.receipts": ["fee.create", "fee.delete"],
  "fees.reports": [],
  "targets.all": ["target.manage", "target.assign"],
  "targets.leaderboard": [],
  "targets.incentives": ["incentive.approve"],
  "reports.students": [],
  "reports.admissions": [],
  "reports.attendance": [],
  "reports.faculty": [],
