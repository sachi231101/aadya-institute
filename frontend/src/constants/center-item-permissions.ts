...
export const CENTER_ITEM_READ_PERMISSIONS: Record<string, string[]> = {
  ...
  "communication.whatsapp": ["notification.read", "whatsapp.automation.read", "whatsapp.template.read", "whatsapp.history.read"],
  "communication.email": ["email.read"],
  "communication.automation": ["notification.read", "whatsapp.automation.read"],
...
export const CENTER_ITEM_WRITE_PERMISSIONS: Record<string, string[]> = {
  ...
  "fees.students": ["fee.update"],
  "fees.student_fees": ["fee.update"],
  "fees.payments": ["fee.create"],
  "fees.pending": ["fee.update"],
  "fees.invoices": ["fee.update"],
  "fees.other_invoices": ["fee.create"],
  "fees.receipts": [],
  "fees.reports": [],
  ...
  "communication.automation": ["notification.manage", "whatsapp.automation.manage"],
  "placement.eligible": [],
