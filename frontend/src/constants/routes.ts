export const ROUTES = {
  ...
  ADMIN: {
    ...
    FEES: {
      ...
      invoiceDetail: (id: string) => `/admin/fees/invoices/${id}`,
      OTHER_INVOICES: "/admin/fees/other-invoices",
      OTHER_INVOICE_NEW: "/admin/fees/other-invoices/new",
      OTHER_INVOICE_DETAIL: "/admin/fees/other-invoices/:id",
      otherInvoiceDetail: (id: string) => `/admin/fees/other-invoices/${id}`,
      RECEIPTS: "/admin/fees/receipts",
      RECEIPT_DETAIL: "/admin/fees/receipts/:id",
      receiptDetail: (id: string) => `/admin/fees/receipts/${id}`,
  ...
  FACULTY: {
    ...
    ATTENDANCE_NEW: "/faculty/attendance/new",
