...
/** Zod refine helper for password fields against live institute policy. */
export const passwordMeetsPolicy =
  (policy: Partial<PasswordPolicyFields> | null | undefined) =>
  (password: string): boolean =>
    validatePasswordAgainstPolicy(password, policy) === null;

export const passwordPolicyErrorMessage = (
  password: string,
  policy: Partial<PasswordPolicyFields> | null | undefined
): string =>
