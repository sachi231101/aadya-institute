  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/65 backdrop-blur-xs p-3 sm:p-6 animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-border bg-card flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
                ...
                <span className="flex items-center gap-1 text-muted-foreground">
                  <span>Score:</span>
                  <strong className="text-amber-500 font-bold">{lead.leadScore}/100 🔥</strong>
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 self-end sm:self-center">
            <Button
              ...
              size="sm"
              onClick={onClose}
              className="h-8.5 px-3 text-xs font-bold border-border text-foreground hover:bg-muted/60 gap-1.5 cursor-pointer"
            >
              <X className="h-4 w-4" />
              <span>Close</span>
            </Button>
        ...
        {/* ─── 2. FIXED HORIZONTAL TAB NAVIGATION ─── */}
        <div className="px-4 sm:px-6 py-2 border-b border-border bg-muted/40 shrink-0">
        ...
        {/* ─── 3. ACTIVE SCROLLABLE TAB CONTENT ─── */}
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs">
                  <div>
                    <span className="text-muted-foreground text-[10px] uppercase font-semibold block">Full Name</span>
                    <span className="text-foreground font-bold text-sm mt-0.5 block">{lead.name}</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground text-[10px] uppercase font-semibold block">Primary Mobile</span>
                    <span className="text-foreground font-medium mt-0.5 block">{lead.phone}</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground text-[10px] uppercase font-semibold block">Alternative Mobile</span>
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs">
                  ...
                  <div>
                    ...
                    <span className="text-foreground font-semibold mt-0.5 block">{lead.assignedCounselor}</span>
                  </div>
                  <div>
                    <span className="text-muted-foreground text-[10px] uppercase font-semibold block">Preferred Time</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
                <div className="flex items-center justify-between border-b border-border pb-2.5">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                    <GraduationCap className="h-4 w-4 text-primary" />
                    <span>Primary Course & Curriculum</span>
                  </h3>
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
                <div className="flex items-center justify-between border-b border-border pb-2.5">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                    ...
                    <span>Schedule, Timing & Mode</span>
                  </h3>
          ...
          {activeTab === "Timeline" && (
            <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
              <div className="flex items-center justify-between border-b border-border pb-2.5">
                <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                  <Clock className="h-4 w-4 text-primary" />
                  <span>Chronological Enquiry Activity History</span>
                </h3>
              ...
              <div className="space-y-3 relative pl-4 sm:pl-6 border-l-2 border-border/80">
                {lead.timeline && lead.timeline.length > 0 ? (
                  lead.timeline.map((item, idx) => (
                    <div key={item.id || idx} className="relative space-y-1">
                      <span className="absolute -left-[23px] sm:-left-[31px] top-1.5 w-3 h-3 rounded-full bg-primary ring-4 ring-primary/20" />
          ...
          {activeTab === "Follow-ups" && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-4 shadow-2xs">
                <div className="flex items-center justify-between border-b border-border pb-2.5">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                    ...
                    <span>Previous Follow-ups & History</span>
                  </h3>
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-3.5 shadow-2xs">
                <div className="flex items-center justify-between border-b border-border pb-2.5">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-8.5 px-2.5 rounded-lg border border-border bg-background text-foreground text-xs focus:outline-none focus:ring-1 focus:ring-primary"
                    >
                ...
                <div className="text-xs">
                  ...
                  <textarea
                    ...
                    className="w-full border border-border rounded-xl p-2.5 text-xs bg-background text-foreground min-h-[70px] focus:outline-none focus:ring-1 focus:ring-primary"
                  />
                </div>
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div className="p-4 bg-muted/20 rounded-xl border border-border space-y-3">
                      ...
                      <div className="p-3 bg-card rounded-lg border border-border flex items-center gap-3">
                        <button
                          ...
                          className="h-8 w-8 rounded-full bg-indigo-600 hover:bg-indigo-700 text-white flex items-center justify-center shrink-0 cursor-pointer shadow-xs"
                        >
                    ...
                    <div className="p-4 bg-muted/20 rounded-xl border border-border space-y-2.5 flex flex-col">
                      ...
                      <div className="flex-1 max-h-[220px] overflow-y-auto space-y-2 p-2.5 bg-card rounded-lg border border-border text-[11px] leading-relaxed">
                        <p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-card border border-border rounded-xl p-5 space-y-3.5 shadow-2xs">
                <div className="flex items-center justify-between border-b border-border pb-2.5">
                  <h3 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
                    <Clock className="h-4 w-4 text-primary" />
                    <span>Previous Notes ({lead.notesList?.length || 0})</span>
                  </h3>
                </div>
        ...
        {/* ─── 4. FIXED BOTTOM STICKY ACTION BAR ─── */}
        <div className="border-t border-border bg-card/95 backdrop-blur-xs p-3.5 sm:p-4 flex flex-wrap items-center justify-between gap-3 shrink-0">
          {/* Left Actions */}
