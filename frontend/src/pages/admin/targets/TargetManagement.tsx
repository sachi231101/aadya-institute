    ...
    <PageContainer>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {plansLoading ? (
              ...
              <div className="col-span-full p-12 text-center text-muted-foreground bg-card border border-border rounded-xl shadow-xs">
              ...
              plans.map((plan) => (
                <div
                  key={plan.id}
                  className="bg-card border border-border hover:border-primary/30 transition p-6 rounded-xl shadow-xs flex flex-col justify-between"
                >
                  <div>
      ...
      {showCreatePlanModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="bg-card border border-border w-full max-w-lg rounded-xl p-6 shadow-2xl space-y-5 text-foreground">
