...
export const IncentiveManagement: React.FC = () => {
  ...
  return (
    <PageContainer>
      ...
      <PageHeader
        title={isCounselor ? "My Incentives & Rewards" : "Incentive Approvals & Payouts"}
        description={
          isCounselor
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-card border border-border p-4 rounded-xl shadow-xs">
      ...
      {showApproveModal && selectedIncentive && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="bg-card border border-border w-full max-w-md rounded-xl p-6 shadow-2xl space-y-5 text-foreground">
