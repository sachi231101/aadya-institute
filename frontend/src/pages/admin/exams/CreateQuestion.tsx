      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Author an assessment question with choice options, correct answers, and scoring weights.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <Button
            ...
            className="bg-purple-600 hover:bg-purple-700 text-white font-semibold px-6 shadow-sm"
          >
            {createQuestionMutation.isPending ? (
              <>
                <Loader2 className="h-4 w-4 mr-2 animate-spin" /> Saving Question...
              </>
            ) : (
              "Save Question to Catalog"
            )}
          </Button>
        </div>
      </form>
