                ...
                logs.map(
                  (l: {
                    ...
                    <TableRow key={l.id}>
                      ...
                      <TableCell className="font-medium">{l.entityType}</TableCell>
                      <TableCell>{l.action}</TableCell>
                      <TableCell className="max-w-[180px] truncate text-xs text-text-secondary" title={formatJsonPreview(l.oldData)}>
                        {formatJsonPreview(l.oldData)}
                      </TableCell>
                      <TableCell className="max-w-[180px] truncate text-xs text-text-secondary" title={formatJsonPreview(l.newData)}>
                        {formatJsonPreview(l.newData)}
                      </TableCell>
                    </TableRow>
                  )
                )
