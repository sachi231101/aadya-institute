...
const _INITIAL_AI_CALLING_LEADS: AiCallingLead[] = [
  {
    ...
    aiSummaryDetailed: "Rahul is highly interested in the Digital Marketing Certification course. He enquired specifically about the weekend classroom batch timing, course fees breakdown, duration, and 100% placement support assistance.",
    keyDiscussionPoints: [
      "Interested in weekend batch (Sat & Sun 10 AM - 1 PM)",
      "Asked about total fees (₹28,000) & EMI installment options",
      "Requested placement support & recruitment partners list",
      "Prefers hybrid mode (online live + offline practical labs)",
      "Requested detailed syllabus PDF on WhatsApp"
    ],
    callDuration: "3m 42s",
    callDurationSeconds: 222,
    ...
    nextActionSubtext: "Assign to Counsellor",
    hotLead: true,
    assignedCounsellor: "Priya Singh",
    audioRecordingUrl: "sample_recording_rahul.mp3",
    pipelineStage: "INTERESTED",
    transcript: [
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:05",
        text: "Hello Rahul, this is Aadya Institute calling regarding your Digital Marketing enquiry. Is this a good time to speak?"
      },
      {
        speaker: "LEAD",
        speakerName: "Rahul Sharma",
        time: "00:14",
        text: "Hi yes! I was looking at your course brochure online. Do you offer weekend batches for working professionals?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:26",
        text: "Yes, absolutely! We have dedicated Saturday-Sunday batches with live hands-on projects, SEO, Google Ads, and AI marketing tools. Course duration is 3 months."
      },
      {
        speaker: "LEAD",
        speakerName: "Rahul Sharma",
        time: "00:48",
        text: "That sounds great. What is the fee structure, and is there placement assistance after course completion?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "01:05",
        text: "The total fee is ₹28,000 with 0% interest EMI options, and we provide dedicated placement drives with 50+ hiring partners. Shall I have our senior counsellor share the complete syllabus on WhatsApp?"
      },
      {
        speaker: "LEAD",
        speakerName: "Rahul Sharma",
        time: "01:28",
        text: "Yes please, connect me with the counsellor. I would like to visit the campus this Saturday."
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "01:38",
        text: "Wonderful, Rahul! I have scheduled a campus visit note for our counsellor team. Have a great day!"
      }
    ]
  },
  {
    ...
    aiSummaryDetailed: "Sneha answered the call while in college lectures. She expressed genuine interest in UI/UX and Graphic Design masterclass and requested a callback specifically after 3:00 PM today.",
    keyDiscussionPoints: [
      "Currently in college, busy until afternoon",
      "Interested in Photoshop, Illustrator & Figma tools",
      "Requested callback after 3:00 PM today",
      "Asked if student discounts are available"
    ],
    callDuration: "2m 15s",
    ...
    callbackTime: "Today, 03:00 PM",
    hotLead: false,
    assignedCounsellor: "Priya Singh",
    audioRecordingUrl: "sample_recording_sneha.mp3",
    ...
    transcript: [
      {
        ...
        speakerName: "Aadya Voice Bot",
        time: "00:04",
        text: "Hello Sneha, calling from Aadya Institute regarding Graphic Design & UI/UX training. Am I speaking with Sneha?"
      },
      {
        speaker: "LEAD",
        speakerName: "Sneha Patil",
        time: "00:12",
        text: "Yes, but I am in a college lecture right now. Can someone call me back after 3 PM today?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:22",
        text: "Certainly! I have noted a callback for 3:00 PM today. Our counsellor will call you then with full design portfolio details. Thank you!"
      }
    ]
  },
  {
    ...
    aiSummaryDetailed: "Amit is actively evaluating full-stack web development programs across Bangalore institutes. He has questions on MERN vs Python stack, live capstone projects, and faculty background.",
    keyDiscussionPoints: [
      "Comparing Aadya syllabus with competitor institutes",
      "Wants 1-on-1 technical counselling on MERN stack",
      "Asked about senior faculty profiles and alumni packages",
      "Ready to enroll if syllabus matches backend requirements"
    ],
    callDuration: "4m 10s",
    ...
    hotLead: true,
    assignedCounsellor: "Ramesh Kumar",
    audioRecordingUrl: "sample_recording_amit.mp3",
    pipelineStage: "CONTACTED",
    transcript: [
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:05",
        text: "Hi Amit, this is Aadya Institute. We received your enquiry for Full Stack Web Development."
      },
      {
        speaker: "LEAD",
        speakerName: "Amit Kumar",
        time: "00:15",
        text: "Yes, I am comparing 2-3 institutes. What technologies do you teach in backend and databases?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:30",
        text: "We cover React, Node.js, Express, MongoDB, PostgreSQL, Docker, and AWS deployment with 4 production projects."
      },
      {
        speaker: "LEAD",
        speakerName: "Amit Kumar",
        time: "00:55",
        text: "Can I speak to an instructor or senior academic counsellor to review the detailed project roadmap?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "01:10",
        text: "I am assigning you immediately to our technical counsellor for a direct priority consultation call."
      }
    ]
  },
  {
    ...
    aiSummaryShort: "Call not answered.",
    aiSummaryDetailed: "Automated voice call attempt completed. The call rang for 35 seconds but was not answered by the subscriber. Automated retry queue scheduled.",
    keyDiscussionPoints: [
      "Call rang for 35 seconds - No answer",
      "No voicemail detected",
      "Added to automated retry queue for afternoon slot"
    ],
    callDuration: "0m 00s",
  ...
  },
  {
    ...
    aiSummaryDetailed: "Vikram answered the call and stated he has taken admission in another university degree program and is no longer looking for certification courses at this time.",
    keyDiscussionPoints: [
      "Joined full-time Master's degree elsewhere",
      "Not looking for certification courses at present",
      "Requested to unsubscribe from promotional calls"
    ],
    callDuration: "1m 20s",
    ...
    hotLead: false,
    audioRecordingUrl: "sample_recording_vikram.mp3",
    pipelineStage: "LOST",
    transcript: [
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:04",
        text: "Hello Vikram, calling from Aadya Institute regarding UI/UX Design course."
      },
      {
        speaker: "LEAD",
        speakerName: "Vikram Singh",
        time: "00:12",
        text: "Hey, thank you for calling, but I have already enrolled in my Master's program in Pune, so I won't be joining any course."
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:25",
        text: "Understood Vikram. Wishing you the best with your Master's! We have updated our records."
      }
    ]
  },
  {
    ...
    attempt: 1,
    aiOutcome: "INTERESTED",
    aiSummaryShort: "Ready for demo class.",
    aiSummaryDetailed: "Arjun is enthusiastic about Generative AI & Python development. He asked for an interactive faculty demo session this Sunday at 11:30 AM.",
    keyDiscussionPoints: [
      "Confirmed interest in Python + Generative AI track",
      "Requested demo session link for Sunday 11:30 AM",
      "Has prior basic coding background in C/Java",
      "Interested in fast-track certification"
    ],
    callDuration: "3m 05s",
    ...
    starRating: 5,
    nextActionType: "CONTACT_NOW",
    nextActionLabel: "Assign to Counsellor",
    nextActionSubtext: "Demo Scheduled",
    hotLead: true,
    assignedCounsellor: "Priya Singh",
    audioRecordingUrl: "sample_recording_arjun.mp3",
    pipelineStage: "INTERESTED",
    transcript: [
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:05",
        text: "Hello Arjun, this is Aadya Institute regarding your Python AI roadmap enquiry."
      },
      {
        speaker: "LEAD",
        speakerName: "Arjun Reddy",
        time: "00:15",
        text: "Hi, I wanted to attend a demo class to see how Generative AI modules and LLMs are taught."
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:30",
        text: "We have a live masterclass demo this Sunday at 11:30 AM. Would you like me to reserve your free seat?"
      },
      {
        speaker: "LEAD",
        speakerName: "Arjun Reddy",
        time: "00:45",
        text: "Yes, definitely. Please send the link to my WhatsApp."
      }
    ]
  },
  {
    ...
    attempt: 1,
    aiOutcome: "CALLBACK_REQUESTED",
    aiSummaryShort: "Call next week, busy now.",
    aiSummaryDetailed: "Kavya is currently traveling for family commitments. She requested a follow-up call next Tuesday morning regarding Java Full Stack curriculum and placement statistics.",
    keyDiscussionPoints: [
      "Traveling until Monday",
      "Requested follow-up next week (Tuesday 11 AM)",
      "Interested in Core Java, Spring Boot & Microservices",
      "Seeking internship placement assistance"
    ],
    callDuration: "2m 40s",
    callDurationSeconds: 160,
    callTimestamp: "Today, 08:10 AM",
    callDate: "24 Aug 2026, 08:10 AM",
    campaign: "August Admission Drive",
    aiScore: 80,
    starRating: 4,
    nextActionType: "FOLLOW_UP",
    nextActionLabel: "Follow Up",
    nextActionSubtext: "Next Week",
    hotLead: false,
    assignedCounsellor: "Priya Singh",
    audioRecordingUrl: "sample_recording_kavya.mp3",
    ...
    transcript: [
      {
        ...
        speakerName: "Aadya Voice Bot",
        time: "00:04",
        text: "Hello Kavya, calling from Aadya Institute regarding your Java Full Stack enquiry."
      },
      {
        speaker: "LEAD",
        speakerName: "Kavya Menon",
        time: "00:14",
        text: "Hi, I am out of town right now. Can you please call me next week on Tuesday morning?"
      },
      {
        speaker: "AI",
        speakerName: "Aadya Voice Bot",
        time: "00:25",
        text: "Noted with thanks, Kavya. We will connect on Tuesday at 11:00 AM. Have a safe trip!"
      }
    ]
  }
];
