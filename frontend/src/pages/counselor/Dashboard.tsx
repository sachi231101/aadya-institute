            ...
            <form onSubmit={handleSaveFollowUpModal} className="space-y-4.5 pt-2 text-xs">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-200/70 space-y-3 shadow-2xs">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#2563EB] text-white font-black flex items-center justify-center text-sm shadow-xs shrink-0">
                  ...
                  <div className="flex items-center gap-2 self-start sm:self-auto">
                    <Badge className="bg-blue-50 text-[#2563EB] border border-blue-200 font-bold text-[11px] px-2.5 py-0.5">
                      {activeLead.course}
                    </Badge>
              ...
              <div className="space-y-2.5 p-3.5 bg-slate-50 rounded-2xl border border-slate-200/70">
                <div className="flex items-center justify-between">
                  <Label className="text-slate-700 font-bold text-xs flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-[#2563EB]" /> Schedule Reminder
                  </Label>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {[
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-lg bg-white hover:bg-blue-50 text-slate-700 hover:text-[#2563EB] text-[10.5px] font-bold transition-all cursor-pointer border border-slate-200 shadow-2xs"
                    >
                      ⚡ {p.label}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full h-9.5 px-3 border border-slate-200 rounded-xl text-xs bg-white font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-[#2563EB] shadow-2xs"
                    >
              ...
              <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center justify-end gap-2.5">
                  ...
                  <Button
                    type="submit"
                    className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-xs font-bold px-5 rounded-xl shadow-md gap-1.5 cursor-pointer h-9.5"
                  >
          ...
          <form onSubmit={handleCreateBatchSubmit} className="space-y-4 pt-3 text-xs">
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
              <h5 className="font-bold text-slate-800 text-xs flex items-center gap-1.5">
                <BookOpen className="h-4 w-4 text-[#2563EB]" /> 1. Batch & Course Information
              </h5>
            ...
            <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 space-y-3">
              ...
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full h-9 px-3 text-xs font-bold text-slate-800 bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-[#2563EB]/30"
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full h-9 px-3 text-xs bg-white border border-slate-200 rounded-lg outline-none focus:ring-2 focus:ring-[#2563EB]/30"
                  >
            ...
            <DialogFooter className="pt-2">
              ...
              <Button
                ...
                className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-xs font-bold gap-1.5 shadow-md"
              >
          ...
          <div className="p-5 sm:p-6 pb-4 border-b border-slate-100 bg-slate-50/70 space-y-4">
            ...
            {activeAiLead && (
              <div className="p-3.5 bg-white rounded-2xl border border-slate-200/80 flex items-center justify-between gap-3 shadow-2xs">
                ...
                <Badge className="bg-blue-50 text-[#2563EB] border border-blue-200 font-bold text-[11px] px-2.5 py-1 shrink-0">
                  {activeAiLead.course}
                </Badge>
              </div>
            )}
            ...
            <div className="p-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-xs font-bold rounded-xl h-9.5 px-4 gap-1.5 shadow-sm"
                >
