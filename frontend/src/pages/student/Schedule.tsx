    ...
    <PageContainer className="animate-in fade-in duration-300 font-sans">
      ...
      <div className="flex items-center gap-2 justify-between">
        <button
          ...
          className="h-9 w-9 rounded-xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-card hover:bg-slate-50 dark:hover:bg-[#162547] flex items-center justify-center text-slate-600 dark:text-slate-300 shrink-0 shadow-2xs cursor-pointer transition-colors"
        >
              ...
              <button
                ...
                className={`flex-1 min-w-[62px] sm:min-w-[76px] py-2 sm:py-2.5 px-1.5 rounded-xl flex flex-col items-center justify-between text-center transition-all cursor-pointer ${
                  isSelected
                    ...
                    : "bg-white dark:bg-card border border-slate-200/80 dark:border-slate-800/80 text-slate-600 dark:text-slate-400 hover:border-blue-300 dark:hover:border-slate-700 hover:bg-slate-50/80 dark:hover:bg-[#152342] shadow-2xs"
                }`}
              >
                ...
                <span className={`text-sm sm:text-base font-semibold my-0.5 ${isSelected ? "text-white" : "text-slate-800 dark:text-slate-200"}`}>
                  ...
                  <span
                    className={`px-1.5 py-0.2 rounded-full text-[8.5px] font-semibold uppercase tracking-wider ${
                      isSelected
                        ...
                        : "bg-blue-100 text-primary dark:bg-blue-950/60 dark:text-sky-400"
                    }`}
                  >
                    TODAY
                  </span>
      ...
      <PageSection
        title={formatDayHeader(selectedDay)}
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          {isLoading ? (
            <div className="p-10 text-center bg-white dark:bg-card border border-slate-200/80 dark:border-slate-800/80 rounded-xl text-slate-400 text-xs">
              Loading your schedule...
            </div>
          ) : daySessions.length === 0 ? (
            <div className="bg-white dark:bg-[#0E172A] border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-8 sm:p-10 text-center space-y-2.5 shadow-xs">
            ...
            daySessions.map((session) => {
              ...
              return (
                <div
                  key={session.id}
                  className={`bg-white dark:bg-card border border-slate-200/80 dark:border-slate-800/80 rounded-xl shadow-xs overflow-hidden transition-all hover:border-slate-300 dark:hover:border-slate-700 ${borderLeftClass}`}
                >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-3.5 min-w-0">
                      ...
                      <div className="flex sm:flex-col items-center sm:items-start gap-1.5 sm:gap-0.5 shrink-0 min-w-[110px]">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] font-semibold uppercase tracking-wider text-slate-800 dark:text-slate-200">
                      ...
                      {/* Course Avatar Badge */}
                      <div
                        className={`h-9 w-9 sm:h-10 sm:w-10 rounded-xl ${session.avatarBg} font-semibold text-xs flex items-center justify-center shrink-0 shadow-2xs`}
                      >
                        {session.avatarText}
                      </div>
                      ...
                      <div className="min-w-0 space-y-0.5">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className="px-1.5 py-0.2 rounded bg-blue-50 text-primary border border-blue-200 dark:bg-blue-950/60 dark:text-sky-400 dark:border-sky-800/50 text-[9px] font-semibold uppercase">
                            {session.courseCode}
                          </span>
                        </div>
                      ...
                      {lifecycle.stage === "UPCOMING" && (
                        <div className="flex items-center gap-2.5">
                          ...
                          <Button
                            disabled
                            variant="outline"
                            className="h-8 px-3 text-[11px] font-bold text-slate-400 dark:text-slate-500 border-slate-200 dark:border-slate-800 bg-slate-100/70 dark:bg-card rounded-xl cursor-not-allowed opacity-75 flex items-center gap-1"
                          >
                      ...
                      {lifecycle.stage === "LIVE_NOW" && (
                        <div className="flex items-center gap-3 flex-wrap">
                          ...
                          <Button
                            ...
                            className="h-8 px-4 text-xs font-semibold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 rounded-xl shadow-xs shadow-emerald-600/20 flex items-center gap-1.5 cursor-pointer transition-all hover:scale-102"
                          >
                        ...
                        <div className="flex items-center gap-2">
                          {availableRecordingSessionIds.has(session.id) && (
                            <Button
                              ...
                              className="h-8 px-2.5 text-xs font-bold text-primary border-blue-200 hover:bg-blue-50 dark:hover:bg-blue-950/40 rounded-xl"
                            >
                      ...
                      {lifecycle.stage === "FEEDBACK_SUBMITTED" && (
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <Button
                            ...
                            className="h-8 px-2.5 text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white bg-white dark:bg-muted hover:bg-slate-50 dark:hover:bg-[#152342] border-slate-200 dark:border-slate-700 rounded-xl cursor-pointer"
                          >
      ...
      >
        <DialogContent className="max-w-xl rounded-xl p-6 bg-white dark:bg-card border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white max-h-[90vh] overflow-y-auto">
          {activeFeedbackModalSession && (
            <>
              <DialogHeader>
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-[#6366F1] to-[#8B5CF6] text-white flex items-center justify-center shrink-0 shadow-xs">
              ...
              <div className="p-3.5 bg-slate-50 dark:bg-muted rounded-xl border border-slate-200/80 dark:border-slate-800 grid grid-cols-2 gap-2 text-xs">
                <div>
              ...
              <div className="space-y-4 pt-1 text-xs">
                ...
                <div className="p-3.5 rounded-xl bg-white dark:bg-[#0B1325] border border-slate-200 dark:border-slate-800 space-y-1.5">
      ...
      <Dialog open={!!liveJoiningSession} onOpenChange={(open) => !open && setLiveJoiningSession(null)}>
        <DialogContent className="max-w-md rounded-xl p-6 bg-white dark:bg-card border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white">
          {liveJoiningSession && (
            <>
              <DialogHeader>
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-500/20 dark:text-emerald-400 flex items-center justify-center">
              ...
              <div className="space-y-4 pt-2">
                <div className="p-4 rounded-xl bg-slate-50 dark:bg-[#0B1325] border border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center space-y-3">
                  <div className="h-20 w-20 rounded-full bg-slate-200/80 dark:bg-slate-800/80 border border-slate-300 dark:border-slate-700 flex items-center justify-center text-slate-600 dark:text-slate-400">
                    <Camera className="h-8 w-8 text-primary dark:text-indigo-400" />
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <div className="space-y-1.5 text-xs text-slate-600 dark:text-slate-400 bg-slate-50 dark:bg-muted p-3 rounded-xl border border-slate-200 dark:border-slate-800/80">
          ...
          {viewingFeedbackSession && (
            <>
              ...
              <div className="space-y-3 pt-2 text-xs">
                <div className="p-3.5 bg-slate-50 dark:bg-muted rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-2">
              ...
              <DialogFooter className="pt-2">
                <Button
                  ...
                  className="w-full bg-primary hover:bg-primary text-white text-xs font-bold rounded-xl h-10"
                >
                  Close
                </Button>
              </DialogFooter>
